        ...
        <div style="background:#f5f5f5;padding:20px;position:relative">
            ...
            <div style="margin-left:20px;">
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=add" method="post">
                    ...
                    <div class="form-group">
                        <h5>返回结果</h5>
                        <textarea name="re" rows="3" class="form-control myCode" placeholder="返回结果"></textarea>
                    </div>
                    <div class="form-group">
                        <h5>备注</h5>
        ...
        <div style="background:#f5f5f5;padding:20px;position:relative">
            ...
            <div style="margin-left:20px;">
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=edit" method="post">
                    ...
                    <div class="form-group">
                        <h5>返回结果</h5>
                        <textarea name="re" rows="3" class="form-control myCode" placeholder="返回结果"><?php echo $info['re']?></textarea>
                    </div>
                    <div class="form-group">
                        <h5>备注</h5>
    ...
    <?php if(count($list)){ ?>
        ...
        <div class="info_api" style="border:1px solid #ddd;margin-bottom:20px;" id="info_api_<?php echo md5($v['id'])?>">
            ...
            <div style="background:#ffffff;padding:20px;">
                ...
                <textarea id="myCode" name="myCode" class="myCode"><?php echo $v['re']?></textarea>
            </div>
            <?php } ?>
            <?php if(!empty($v['memo'])){ ?>
            <div style="background:#ffffff;padding:20px;">
                <h5 class="textshadow">备注</h5>
                <pre style="background:#000; color: #fcfcfc;"><?php echo $v['memo']?></pre>
            </div>
            <?php } ?>
        </div>
        <!--接口详细列表end-->
