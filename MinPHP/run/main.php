...
<head>
    ...
    <!--codeMirror-->
    <link href="./MinPHP/res/codemirror-5.25.0/lib/codemirror.css" rel="stylesheet">
    <link href="./MinPHP/res/codemirror-5.25.0/theme/monokai.css" rel="stylesheet">
...
<!--codeMirror-->
<script src="./MinPHP/res/codemirror-5.25.0/lib/codemirror.js"></script>
<script src="./MinPHP/res/codemirror-5.25.0/mode/javascript/javascript.js"></script>
<script>
    ...
    $(function(){
        var param = GetQueryString('op');
        if(param === 'add' || param === 'edit'){
            var editor = CodeMirror.fromTextArea(
                document.getElementsByClassName('myCode')[0],
                {
